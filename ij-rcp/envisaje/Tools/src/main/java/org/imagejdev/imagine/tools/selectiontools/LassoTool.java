...
package org.imagejdev.imagine.tools.selectiontools;
...
import org.imagejdev.paint.api.splines.Close;
import org.imagejdev.paint.api.splines.CurveTo;
import org.imagejdev.paint.api.splines.DefaultPathModel;
import org.imagejdev.paint.api.splines.Entry;
import org.imagejdev.paint.api.splines.Hit;
import org.imagejdev.paint.api.splines.LineTo;
import org.imagejdev.paint.api.splines.MoveTo;
import org.imagejdev.paint.api.splines.Node;
import org.imagejdev.paint.api.splines.PathModel;
import org.imagejdev.paint.api.splines.QuadTo;
...
//            hit.getNode().setLocation(e.getPoint());
    ...
    public Icon getIcon() {
        return new ImageIcon (Utilities.loadImage(
                "org/imagejdev/imagine/tools/resources/lasso.png"));
    }
