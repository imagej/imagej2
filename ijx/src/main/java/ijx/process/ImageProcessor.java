...
public abstract class ImageProcessor extends Object {
    ...
    public boolean isPseudoColorLut() {
		...
		if (ijx.IJ.debugMode)
			ijx.IJ.log("isPseudoColorLut: "+(isPseudoColor) + " " + stdDev);
	...
	public void setAutoThreshold(Method method, boolean darkBackground, int lutUpdate) {
		...
		int options = ijx.measure.Measurements.AREA+ ijx.measure.Measurements.MIN_MAX+ ijx.measure.Measurements.MODE;
	...
	*/
	public void setBinaryThreshold() {
		...
		if ((invertedLut&&ijx.Prefs.blackBackground) || (!invertedLut&&!ijx.Prefs.blackBackground)) {
			t1 = 0.0;
			t2 = 0.0;
		}
