...
public class FileOpener {
	...
	public void revertToSaved(ImagePlus imp) {
		// CTR TODO - verify all image metadata is carried over
		final ImagePlus orig = new Opener().openImage(fi.directory, fi.fileName);
		imp.setStack(orig.getStack(),
			orig.getNChannels(), orig.getNSlices(), orig.getNFrames());
	}
