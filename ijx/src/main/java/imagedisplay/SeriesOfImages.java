...
public class SeriesOfImages implements SeriesFileListener
{
    ...
    public SeriesOfImages (String seriesFile) {
        // a time series, default interval one 'unit'
        this(seriesFile, 1);
    }


    public SeriesOfImages (String seriesFile, long interval) {
    ...
    public SeriesOfImages (String seriesFile, int zSections) {
        // a ZT series
        this(seriesFile, zSections, 0);
    }


    public SeriesOfImages (String seriesFile, int zSections, long interval) {
