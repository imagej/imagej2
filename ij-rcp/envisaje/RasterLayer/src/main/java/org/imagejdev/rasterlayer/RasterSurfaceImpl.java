...
import org.imagejdev.imagenio.image.ByteNIOBufferedImage;
import org.imagejdev.imagenio.image.ImageHolder;
...
class RasterSurfaceImpl extends SurfaceImplementation implements RepaintHandle {
   ...
   private void takeSnapshot() {
    ...
    private static class HibernateQueue implements Runnable {
        private java.util.List <RasterSurfaceImpl> queue = Collections.
