...
public class ImageUtils
{
	...
	public static ImgLibProcessor<?> createProcessor(int width, int height, Object pixels, ValueType type)
	{
		...
		switch (type)
		{
			...
			case UBYTE:
			{
				Image<UnsignedByteType> hatchedImage = imagej2.imglib.process.ImageUtils.createImage(new UnsignedByteType(), containerFactory, dimensions);
			...
			case UINT12:
			{
				Image<Unsigned12BitType> hatchedImage = imagej2.imglib.process.ImageUtils.createImage(new Unsigned12BitType(), containerFactory, dimensions);
			...
			case SHORT:
			{
				Image<ShortType> hatchedImage = imagej2.imglib.process.ImageUtils.createImage(new ShortType(), containerFactory, dimensions);
			...
			case USHORT:
			{
				Image<UnsignedShortType> hatchedImage = imagej2.imglib.process.ImageUtils.createImage(new UnsignedShortType(), containerFactory, dimensions);
			...
			case INT:
			{
				Image<IntType> hatchedImage = imagej2.imglib.process.ImageUtils.createImage(new IntType(), containerFactory, dimensions);
			...
			case UINT:
			{
				Image<UnsignedIntType> hatchedImage = imagej2.imglib.process.ImageUtils.createImage(new UnsignedIntType(), containerFactory, dimensions);
			...
			case LONG:
			{
				Image<LongType> hatchedImage = imagej2.imglib.process.ImageUtils.createImage(new LongType(), containerFactory, dimensions);
			...
			case FLOAT:
			{
				Image<FloatType> hatchedImage = imagej2.imglib.process.ImageUtils.createImage(new FloatType(), containerFactory, dimensions);
			...
			case DOUBLE:
			{
				Image<DoubleType> hatchedImage = imagej2.imglib.process.ImageUtils.createImage(new DoubleType(), containerFactory, dimensions);
	...
	{
		final int sizeX = imagej2.imglib.process.ImageUtils.getWidth(img);
		final int sizeY = imagej2.imglib.process.ImageUtils.getHeight(img);
		final int sizeC = imagej2.imglib.process.ImageUtils.getNChannels(img);
		final int sizeZ = imagej2.imglib.process.ImageUtils.getNSlices(img);
		final int sizeT = imagej2.imglib.process.ImageUtils.getNFrames(img);
