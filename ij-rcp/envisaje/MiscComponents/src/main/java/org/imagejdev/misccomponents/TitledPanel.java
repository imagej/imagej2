...
public abstract class TitledPanel extends JPanel implements LayoutDataProvider {
    ...
    protected TitledPanel (String title) {
        ...
        expandButton.setIcon(new ImageIcon (Utilities.loadImage(
                "org/imagejdev/misccomponents/turner-right.png"))); //NOI18N
        ...
        ImageIcon icon = new ImageIcon (Utilities.loadImage(
                "org/imagejdev/misccomponents/info.png")); //NOI18N
...
//                expandButton.setIcon(new ImageIcon (Utilities.loadImage("org/imagejdev/misccomponents/turner-down.png")));
            } else {
//                expandButton.setIcon(new ImageIcon (Utilities.loadImage("org/imagejdev/misccomponents/turner-right.png")));
    ...
    private String getImageNameForState (boolean expanded, boolean containsMouse) {
        return "org/imagejdev/misccomponents/turner-" + (expanded ? "down" : "right") + //NOI18N
