...
@see ImageJ
 */
public class MenusAWT implements IjxMenus {

  private static MenusAWT instance;
  //private static ImageJ ij;
  private ImageJApplet applet;
  public static boolean jnlp; // true when using Java WebStart
  //
  ...
  private static Menu openRecentMenu;
  ...
  // @todo: move these to a global place of some sort
  ...
  public MenusAWT(IjxTopComponent tc, IjxApplication _ijApp, Applet appletInstance) {
    topComponent = tc;
    ijApp = _ijApp;
  ...
  public void updateImageJMenus() {
    ...
    MenusAWT m = new MenusAWT(IJ.getTopComponent(), ijApp, (ImageJApplet) IJ.getApplet());
