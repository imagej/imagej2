...
public class RoiTest {
	...
	public void testDrawPixelsImageProcessor() {
		...
		tryOneDraw(2,2,new Rectangle(0,0,1,1), new byte[]{3,3,3,3});
		tryOneDraw(2,2,new Rectangle(1,0,1,2), new byte[]{0,3,0,3});
		tryOneDraw(3,3,new Rectangle(0,0,3,3), new byte[]{3,3,3,3,0,0,3,0,0});
		tryOneDraw(3,3,new Rectangle(1,1,1,1), new byte[]{0,0,0,0,3,3,0,3,3});
		tryOneDraw(3,3,new Rectangle(0,1,2,2), new byte[]{0,0,0,3,3,3,3,0,3});
	}
