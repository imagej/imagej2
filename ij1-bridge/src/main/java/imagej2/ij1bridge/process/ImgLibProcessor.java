...
import imagej2.function.binary.AddFloatBinaryFunction;
import imagej2.function.binary.AddIntegralBinaryFunction;
import imagej2.function.binary.AndBinaryFunction;
import imagej2.function.binary.AverageFloatBinaryFunction;
import imagej2.function.binary.AverageIntegralBinaryFunction;
import imagej2.function.binary.CopyInput2BinaryFunction;
import imagej2.function.binary.CopyInput2InvertedBinaryFunction;
import imagej2.function.binary.CopyInput2TransparentBinaryFunction;
import imagej2.function.binary.CopyInput2ZeroTransparentBinaryFunction;
import imagej2.function.binary.DifferenceBinaryFunction;
import imagej2.function.binary.DivideBinaryFunction;
import imagej2.function.binary.MaxBinaryFunction;
import imagej2.function.binary.MinBinaryFunction;
import imagej2.function.binary.MultiplyFloatBinaryFunction;
import imagej2.function.binary.MultiplyIntegralBinaryFunction;
import imagej2.function.binary.OrBinaryFunction;
import imagej2.function.binary.SubtractFloatBinaryFunction;
import imagej2.function.binary.SubtractIntegralBinaryFunction;
import imagej2.function.binary.XorBinaryFunction;
import imagej2.function.unary.AbsUnaryFunction;
import imagej2.function.unary.AddFloatUnaryFunction;
import imagej2.function.unary.AddIntegralUnaryFunction;
import imagej2.function.unary.AddNoiseUnaryFunction;
import imagej2.function.unary.AndUnaryFunction;
import imagej2.function.unary.ExpFloatUnaryFunction;
import imagej2.function.unary.ExpIntegralUnaryFunction;
import imagej2.function.unary.FillUnaryFunction;
import imagej2.function.unary.GammaFloatUnaryFunction;
import imagej2.function.unary.GammaIntegralUnaryFunction;
import imagej2.function.unary.IntegralSubstitutionUnaryFunction;
import imagej2.function.unary.InvertUnaryFunction;
import imagej2.function.unary.LogFloatUnaryFunction;
import imagej2.function.unary.LogIntegralUnaryFunction;
import imagej2.function.unary.MaxUnaryFunction;
import imagej2.function.unary.MinUnaryFunction;
import imagej2.function.unary.MultiplyFloatUnaryFunction;
import imagej2.function.unary.MultiplyIntegralUnaryFunction;
import imagej2.function.unary.OrUnaryFunction;
import imagej2.function.unary.SqrFloatUnaryFunction;
import imagej2.function.unary.SqrIntegralUnaryFunction;
import imagej2.function.unary.SqrUshortUnaryFunction;
import imagej2.function.unary.SqrtUnaryFunction;
import imagej2.function.unary.ThresholdUnaryFunction;
import imagej2.function.unary.XorUnaryFunction;
...
import imagej2.imglib.process.operation.BinaryAssignPositionalOperation;
import imagej2.imglib.process.operation.BinaryTransformPositionalOperation;
import imagej2.imglib.process.operation.GetPlaneOperation;
import imagej2.imglib.process.operation.MinMaxOperation;
import imagej2.imglib.process.operation.NAryTransformPositionalOperation;
import imagej2.imglib.process.operation.QueryOperation;
import imagej2.imglib.process.operation.SetPlaneOperation;
import imagej2.imglib.process.operation.TernaryAssignPositionalOperation;
import imagej2.imglib.process.operation.UnaryTransformOperation;
import imagej2.imglib.process.operation.UnaryTransformPositionalOperation;
import imagej2.process.Index;
import imagej2.process.Span;
import imagej2.process.query.HistogramQuery;
import imagej2.selection.MaskOffSelectionFunction;
import imagej2.selection.MaskOnSelectionFunction;
...
public class ImgLibProcessor<T extends RealType<T>> extends ImageProcessor implements java.lang.Cloneable
{
	...
	private void nonPositionalTransform(UnaryFunction function)
	{
		...
		if ((span[0] == getWidth()) &&
				(span[1] == getHeight()) &&
				!(function instanceof imagej2.function.unary.FillUnaryFunction))
			findMinAndMax();
	}
  ...
  @Override
	...
	public void rotate(double angle)
	{
		...
		ImgLibProcessor<?> ip2 = imagej2.ij1bridge.process.ImageUtils.createProcessor(getWidth(), getHeight(), pixels2, this.ijType);
