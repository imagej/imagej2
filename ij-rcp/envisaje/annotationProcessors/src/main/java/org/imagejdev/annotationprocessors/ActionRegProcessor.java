...
package org.imagejdev.annotationprocessors;
...
@SupportedAnnotationTypes("org.imagejdev.annotations.ActionRegistration") // NOI18N
public final class ActionRegProcessor extends LayerGeneratingProcessor {
    ...
    protected boolean handleProcess(
        ...
        for (Element e : roundEnv.getElementsAnnotatedWith(ActionRegistration.class)) {
            ...
            if (ar.key().length() == 0) {
                f.methodvalue("instanceCreate", "org.imagejdev.annotations.ActionRegistration", "alwaysEnabled");
            } else {
                f.methodvalue("instanceCreate", "org.imagejdev.annotations.ActionRegistration", "callback");
                f.methodvalue("fallback", "org.imagejdev.annotations.ActionRegistration", "alwaysEnabled");
    ...
    private void generateContext(Element e, File f) throws LayerGenerationException {
        ...
        if ("java.util.Collection".equals(dtName)) {
            ...
            f.methodvalue("delegate", "org.imagejdev.annotations.ActionRegistration", "inject");
            ...
            f.methodvalue("instanceCreate", "org.imagejdev.annotations.ActionRegistration", "context");
            return;
        }
