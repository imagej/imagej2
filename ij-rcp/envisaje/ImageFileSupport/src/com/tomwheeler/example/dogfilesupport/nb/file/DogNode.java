 ...
 * Dog data object. The node is the visual representation that is displayed by
 ...
 * @author Tom Wheeler
 */
public class DogNode extends DataNode implements PropertyChangeListener {

    private static final String IMAGE_ICON_BASE = "com/tomwheeler/example/dogfilesupport/nb/resources/dogicon";

    private DogDataObject ddo;

    public DogNode(DogDataObject obj) {
