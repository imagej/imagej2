...
public class Ij1PluginRunner {
    ...
    public static <T extends RealType<T>> void main(String[] args) {
        ...
        try {
            ...
            runPlugin(command, plugin, imgName, img);
    ...
    public static <T extends RealType<T>> boolean runPlugin(String command, String plugin, String imgName, Image<T> img) {
        ...
        imp.show();
        runCommand(command, plugin, false);
        return true;
    }

    public static Object runCommand(String commandName, String className, boolean createNewLoader) {
        if (className != null) {
            String arg = "";
