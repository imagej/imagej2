...
// BDZ - BEGIN CHANGES
it was read from). The ImageProcessor contains the pixel data (various bit depths) 
of the 2D image and some basic methods to manipulate it. An ImageStack is essentially 
// BDZ - END CHANGES
