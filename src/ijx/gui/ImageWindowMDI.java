...
public class ImageWindowMDI extends JInternalFrame implements IjxImageWindow {
  ...
  public ImageWindowMDI(String title) {
    super(title);
  }

  public ImageWindowMDI(IjxImagePlus imp) {
    this(imp, null);
  }

  public ImageWindowMDI(IjxImagePlus imp, IjxImageCanvas ic) {
    super(imp.getTitle());
    ...
    this.ic = ic;
    ImageWindowMDI previousWindow = (ImageWindowMDI) imp.getWindow();
...
//				GUI.center(this);
  ...
  public void updateImage(IjxImagePlus imp) {
    ...
    //this.setLocationAndSize(xloc, yloc, newWidth, newHeight);
