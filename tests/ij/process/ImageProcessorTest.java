...
public class ImageProcessorTest 
{
	...
	public void testResetMinAndMax() 
	{
		...
		double minCP = testColorProcessor.getMin();
		double maxCP = testColorProcessor.getMax();
	...
	{	
		ColorProcessor testColorProcessor = new ColorProcessor(width, height, getRefImageArray() );
		AutoThresholder testAT = new AutoThresholder();
		double[] refArray = {187.21334132983154, 99.59616325994367, 171.30304713031046, 129.4460337520425, 184.02226974717172, 90.50813514351626, 187.21334132983154, 99.59616325994367, 175.230068469893, 120.92320323546852, 167.46769348774092, 82.31948628040253, 178.4646186466213, 113.04615207037888, 162.556407546626, 159.05625743073654, 154.37544863381942, 75.80056754637253, 188.33815088314768, 95.85283022962068, 187.69320164875393, 98.81616015651879, 175.230068469893, 120.92320323546852, 166.96979760715195, 82.04717497273947, 166.96979760715195, 82.04717497273947, 168.09920657986515, 146.01645935053864, 164.48888747597542, 80.63116891138247};
		ByteProcessor testBP = null;
		int refIndex = 0;
		
		//get the thresholding methods
		String[] methods = testAT.getMethods();
	...
	public void testSetAutoThresholdIntInt() 
	{
		ColorProcessor testColorProcessor = new ColorProcessor(width, height, getRefImageArray() );
		AutoThresholder testAT = new AutoThresholder();
		double[] refArray = {187.21334132983154, 99.59616325994367, 187.21334132983154, 99.59616325994367, 187.21334132983154, 99.59616325994367, 187.21334132983154, 99.59616325994367, 171.30304713031046, 129.4460337520425, 171.30304713031046, 129.4460337520425, 171.30304713031046, 129.4460337520425, 171.30304713031046, 129.4460337520425, 184.02226974717172, 90.50813514351626, 184.02226974717172, 90.50813514351626, 184.02226974717172, 90.50813514351626, 184.02226974717172, 90.50813514351626, 187.21334132983154, 99.59616325994367, 187.21334132983154, 99.59616325994367, 187.21334132983154, 99.59616325994367, 187.21334132983154, 99.59616325994367, 175.230068469893, 120.92320323546852, 175.230068469893, 120.92320323546852, 175.230068469893, 120.92320323546852, 175.230068469893, 120.92320323546852, 167.46769348774092, 82.31948628040253, 167.46769348774092, 82.31948628040253, 167.46769348774092, 82.31948628040253, 167.46769348774092, 82.31948628040253, 178.4646186466213, 113.04615207037888, 178.4646186466213, 113.04615207037888, 178.4646186466213, 113.04615207037888, 178.4646186466213, 113.04615207037888, 162.556407546626, 159.05625743073654, 162.556407546626, 159.05625743073654, 162.556407546626, 159.05625743073654, 162.556407546626, 159.05625743073654, 154.37544863381942, 75.80056754637253, 154.37544863381942, 75.80056754637253, 154.37544863381942, 75.80056754637253, 154.37544863381942, 75.80056754637253, 188.33815088314768, 95.85283022962068, 188.33815088314768, 95.85283022962068, 188.33815088314768, 95.85283022962068, 188.33815088314768, 95.85283022962068, 187.69320164875393, 98.81616015651879, 187.69320164875393, 98.81616015651879, 187.69320164875393, 98.81616015651879, 187.69320164875393, 98.81616015651879, 175.230068469893, 120.92320323546852, 175.230068469893, 120.92320323546852, 175.230068469893, 120.92320323546852, 175.230068469893, 120.92320323546852, 166.96979760715195, 82.04717497273947, 166.96979760715195, 82.04717497273947, 166.96979760715195, 82.04717497273947, 166.96979760715195, 82.04717497273947, 166.96979760715195, 82.04717497273947, 166.96979760715195, 82.04717497273947, 166.96979760715195, 82.04717497273947, 166.96979760715195, 82.04717497273947, 168.09920657986515, 146.01645935053864, 168.09920657986515, 146.01645935053864, 168.09920657986515, 146.01645935053864, 168.09920657986515, 146.01645935053864, 164.48888747597542, 80.63116891138247, 164.48888747597542, 80.63116891138247, 164.48888747597542, 80.63116891138247, 164.48888747597542, 80.63116891138247};
		ByteProcessor testBP = null;
		int refIndex = 0;
		...
		for (String method : methods )
		{
			for(int l:LUT)
			{
				...
				ImageStatistics stats = ImageStatistics.getStatistics(testBP, 0xffffffff, null);
				stats.getCentroid( testBP );
				//System.out.print( stats.xCenterOfMass + ", " + stats.yCenterOfMass + ", ");
				assertEquals( refArray[refIndex++], stats.xCenterOfMass, 0.0 ); 
				assertEquals( refArray[refIndex++], stats.yCenterOfMass, 0.0 );
			}
		}
	...
	public void testGetMask() 
	{
		...
		testColorProcessor.setMask( mask );
		ImageProcessor refMask = (ByteProcessor) testColorProcessor.getMask();
	...
	{	
		String[] testInterpolationMethods = ImageProcessor.getInterpolationMethods();
		String[] refInterpolationMethods = new String[] {"None", "Bilinear", "Bicubic"};
		
		List l = Arrays.asList( refInterpolationMethods );
	...
	{
		ColorProcessor testColorProcessor = new ColorProcessor( width, height, getRefImageArray() );
		testColorProcessor.setOverColor(0, 0, 0);
	}
	...
	{
		ColorProcessor testColorProcessor = new ColorProcessor( width, height, getRefImageArray() );
		testColorProcessor.setUnderColor( 0, 0, 0 );	
	}
