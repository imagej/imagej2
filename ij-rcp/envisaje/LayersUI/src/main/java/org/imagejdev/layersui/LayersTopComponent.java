package org.imagejdev.layersui;
...
final class LayersTopComponent extends TopComponent implements LookupListener,
	...
	scrollPane.setViewportBorder (BorderFactory.createEmptyBorder ());
        ...
        newButton.setToolTipText(NbBundle.getMessage(LayersTopComponent.class,
                                                     "LBL_New"));
        newButton.setIcon(new ImageIcon(Utilities.loadImage("org/imagejdev/layersui/resources/newlayer.png")));
        ...
        delButton.setToolTipText(NbBundle.getMessage(LayersTopComponent.class,
                                                     "LBL_Delete"));
        delButton.setIcon(new ImageIcon(Utilities.loadImage("org/imagejdev/layersui/resources/delete.png")));
        ...
        upButton.setToolTipText(NbBundle.getMessage(LayersTopComponent.class,
                                                    "LBL_Up"));
        upButton.setIcon(new ImageIcon(Utilities.loadImage("org/imagejdev/layersui/resources/up.png")));
        ...
        downButton.setToolTipText(NbBundle.getMessage(LayersTopComponent.class,
                                                      "LBL_Down"));
        downButton.setIcon(new ImageIcon(Utilities.loadImage("org/imagejdev/layersui/resources/down.png")));
        ...
        dupButton.setToolTipText(NbBundle.getMessage(LayersTopComponent.class,
                                                     "LBL_Duplicate"));
        dupButton.setIcon(new ImageIcon(Utilities.loadImage("org/imagejdev/layersui/resources/clone.png")));
        ...
        flattenButton.setToolTipText(NbBundle.getMessage(LayersTopComponent.class,
                                                         "LBL_Flatten"));
        flattenButton.setIcon(new ImageIcon(Utilities.loadImage("org/imagejdev/layersui/resources/flatten.png")));
