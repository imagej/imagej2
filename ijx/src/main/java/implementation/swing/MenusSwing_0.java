...
@see ImageJ
 */
public class MenusSwing_0 implements IjxMenus {
    private static IjxTopComponent topComponent;
    private static IjxApplication ijApp;
    private static JMenuBar mbar;
    private static JCheckBoxMenuItem gray8Item, gray16Item, gray32Item, color256Item,
            colorRGBItem, RGBStackItem, HSBStackItem;
    ...
    private static Vector jarFiles;  // JAR files in plu▬gins folder with "_" in their name
    private static Vector macroFiles;  // Macros and sc☻ripts in the plugins folder
    ...
    static int windowMenuItems2; // non-image windows lis☻ted in Window menu + separator
    ...
    public MenusSwing_0(IjxTopComponent tc, IjxApplication _ijApp, Applet appletInstance) {
        topComponent = tc;
        ijApp = _ijApp;
...
//    mbar.setHelpMenu(help);
    ...
    public void forceInstallUserPlugin(String className) {
        installUserPlugin(className, true);
    }
...
// <editor-fold defaultstate="collapsed" desc=" Plugins in/from Jar files ">
    ...
    public String getJarFileForMenuEntry(String menuEntry) {
        return (String) menuEntry2jarFile.get(menuEntry);
    }
...
// <editor-fold defaultstate="collapsed" desc=" Configuration File ">
...
// <editor-fold defaultstate="collapsed" desc=" Getters of menus... ">
    ...
    public JMenu getSaveAsMenu() {
        return this.getMenu("File>Save As");
    }
    ...
    private JMenu getMenu(String menuName, boolean readFromProps) {
...
// @todo Who Knows ??!!
      /*  if (result == null) {
            ...
            if (offset < 0) {
                result = (JMenu) (new JPopupMenu(menuName)).getSubElements();
                if (mbar == null) {
                    if (applet == null) {
                        mbar = new JMenuBar();
            ...
            menusTable.put(menuName, result);
        }}
       *
       */
        return result;
...
// </editor-fold>
     ...
     */
    public int installPlugin(String plugin, char menuCode, String command, String shortcut, IjxApplication ij) {
    ...
    public int uninstallPlugin(String command) {
        boolean found = false;
    ...
    public boolean commandInUse(String command) {
        if (pluginsTable.get(command) != null) {
            return true;
        } else {
            return false;
...
// <editor-fold defaultstate="collapsed" desc=" Short Cut Management ">
    ...
    in the hashtable are Integer keycodes, or keycode+200 for uppercase. */
    public Hashtable getMacroShortcuts() {
    ...
    public boolean shortcutInUse(String shortcut) {
        int code = convertShortcutToCode(shortcut);
...
// <editor-fold defaultstate="collapsed" desc=" Updating Menus ">
    public void updateImageJMenus() {
        shortcuts = new Hashtable();
        pluginsPrefs = new Vector();
        jarFiles = macroFiles = null;
        menusTable = null;
        MenusSwing_0 m = new MenusSwing_0(IJ.getTopComponent(), IJ.getInstance(), IJ.getApplet());
    ...
    private void updateImageTypeMenu() {
        // set the type of the image in the Image:Type menu
        // @todo These become JMenuIemRadioButtons of a ButtonGroup in the menu...
...
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc=" Window Menu Management ">
    public Object getWindowMenu() {
        return window;
    }

    public int getWindowMenuItems2() {
        return windowMenuItems2;
    }
    ...
    public synchronized void insertWindowMenuItem(IjxWindow win) {
    ...
    public synchronized void addWindowMenuItem(IjxImagePlus imp) {
    ...
    public synchronized void removeWindowMenuItem(int index) {
    ...
    public synchronized void updateWindowMenuItem(String oldLabel, String newLabel) {
...
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc=" Recently Opened Menu Management ">
    ...
    public synchronized void addOpenRecentItem(String path) {
        if (ijApp == null) {
            return;
        }
