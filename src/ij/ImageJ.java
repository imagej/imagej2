...
import ijx.FactorySwing;
import ijx.TopComponentSwing;
import ijx.IjxAbstractApplication;
 ...
 */
public class ImageJ extends IjxAbstractApplication {
...
//  private String lastKeyCommand;
  private static boolean swingGUI = false;
  ...
  public ImageJ(java.applet.Applet applet, int mode) {
    ...
    if (swingGUI) {
      ...
      topComponent = new TopComponentSwing(this);
...
//      });
      ...
      topComponent = new TopComponentAWT(this);
    }
    // MDI
    //{
    // +++ IJ.setFactory(new FactoryMDI());
    // +++ topComponent = new TopComponentMDI(this);
    // }
    ...
    // Ijx: The menuBar is added to the topComponent...
    // MenusIjx m = new MenusIjx(topComponent, this, applet);
