...
public class FindEdges<T extends RealType<T>> extends ImglibOutputAlgorithmPlugin<T>
{
	@Parameter
	private Dataset in;
	...
	public void run()
	{
		...
		OutputAlgorithm<T> algorithm = new FindEdgesAlgorithm(in);
	...
	private class FindEdgesAlgorithm implements OutputAlgorithm<T>
	{
