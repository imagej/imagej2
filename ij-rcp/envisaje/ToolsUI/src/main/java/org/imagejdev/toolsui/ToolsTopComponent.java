...
public final class ToolsTopComponent extends TopComponent implements Runnable, Notifiable <Tool> {
    ...
    private ToolsTopComponent() {
        ...
        initComponents();
        setName(NbBundle.getMessage(ToolsTopComponent.class,
                                    "CTL_ToolsTopComponent")); //NOI18N
        setToolTipText(NbBundle.getMessage(ToolsTopComponent.class,
                                           "HINT_ToolsTopComponent")); //NOI18N
