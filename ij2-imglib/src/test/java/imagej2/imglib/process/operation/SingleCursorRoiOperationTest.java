...
import imagej2.imglib.process.operation.SingleCursorRoiOperation;
...
public class SingleCursorRoiOperationTest {
	...
	public void testAllMethods()
	{
		...
		FakeSingleCursorRoiOperation<ByteType> op = new FakeSingleCursorRoiOperation<ByteType>(image,origin,span);

		assertEquals(image, op.getImage());
