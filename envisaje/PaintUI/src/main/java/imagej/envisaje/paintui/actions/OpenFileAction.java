...
import imagej.envisaje.filemanagement.MRUFilesOptions;
...
public class OpenFileAction extends AbstractAction {
    ...
    private static final String ICON_BASE = "imagej/envisaje/paintui/resources/openFile24.png"; //NOI18N
...
//                    }
    ...
    private void updateRecentFileList(File f) {
        MRUFilesOptions opts = MRUFilesOptions.getInstance();
        opts.addFile(f.getAbsolutePath());
    }
